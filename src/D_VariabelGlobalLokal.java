public class D_VariabelGlobalLokal {
    ...
    public static void main(String[] args) {
        varGlobal=25;
        System.out.println("varGlobal diakses dimethod main dengan nilai ="+varGlobal);
    ...
    public static void aksesVariabelLokal(){
        ...
        //varLokal = 2.5;
        System.out.println("varLokal tidak bisa diakses di method aksesVariablLokal ini");
